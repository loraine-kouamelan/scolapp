        ...
        <div class="container">
            <div class="dash-topbar">
                <div class="dash-title">
                    <h1>Paramètres</h1>
                    <p>Gestion des données de base</p>
                </div>
            </div>
            ...
            <div class="dash-grid">
                <div class="dash-col">
                    ...
                    <div class="card">
                        ...
                        <div class="auth-actions">
                            <a class="btn btn-primary" href="classe.php">Ouvrir</a>
                        </div>
                    </div>
                </div>
                ...
                <div class="dash-col">
                    <div class="card">
                        <h2>Matières</h2>
                        <p>Gérer les matières par filière.</p>
                        <div class="auth-actions">
                            <a class="btn btn-primary" href="matiere.php">Ouvrir</a>
                        </div>
                    </div>

                    <div class="card">
                        <h2>Étudiants</h2>
                        <p>Ajouter et gérer les étudiants par classe.</p>
                        <div class="auth-actions">
                            <a class="btn btn-primary" href="etudiant.php">Ouvrir</a>
                        </div>
                    </div>
                </div>
            </div>
